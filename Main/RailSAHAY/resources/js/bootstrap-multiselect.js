...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
                ...
                if (options.length === 0) {
                    ...
                    if (options.length > this.numberDisplayed) {
                        ...
                        options.each(function() {
                            var lbl = $(this).html();
			   				var dispval=lbl.substring(0,lbl.indexOf("-"));
                            selected += dispval + ', ';
                        });
            ...
            buttonTitle: function(options, select) {
                if (options.length === 0) {
                    ...
                    var selected = '';
                    options.each(function () {
						var crntval=$(this).text();
						var dispval=trim(crntval.substring(0,crntval.indexOf('-')));
                        selected += dispval + ', ';
                    });
        ...
        templates: {
            ...
            filter: '<div class="input-group"><span class="input-group-addon"><img src="/foisweb/resources/images/searchicon.png" class="img-rounded" alt="Rounded Image" /></span><input class="form-control multiselect-search" type="text" style="text-transform: uppercase;"></div>',
                        ...
                        this.searchTimeout = this.asyncFunction($.proxy(function() {
                            ...
                            if (this.query !== event.target.value) {
                                ...
                                $.each($('li', this.$ul), $.proxy(function(index, element) {
                                    var value = $('input', element).val().toUpperCase();
                                    var text = $('label', element).text().toUpperCase();
                                    ...
                                    if (value !== this.options.selectAllValue && text) {
                                        ...
                                        if (filterCandidate.toUpperCase().indexOf(this.query.toUpperCase()) > -1) {
                                            showElement = true;
                                        }
