    ...
    { 
      ...
      var myurl="/RailSAHAY/AcqnPlan";
      $("#dtlsGrid").html('<div class="spinner-border text-danger"></div>');
      var htmlstr='<table class="table table-bordered table-data table-mis"><thead><tr><th rowspan="2">SR.No.</th><th rowspan="2">Zone</th><th rowspan="2">File</th><th rowspan="2">Remarks</th><th colspan="2">Upload Detail</th></tr><tr><th>Time</th><th>User</th></tr></thead><tbody>';
     $.ajax({
     url : myurl,
     type : "post",
