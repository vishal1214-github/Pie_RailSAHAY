...
<div class="card">
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item">Submission of Hard copy with application fee (Rs 20,000, only for Greenfield PFTs) in favour to Financial Advisor and Chief Accounts OFficer (FA&CAO)/Zonal Railway</li>
...
<div class="card">
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item">Security deposit 10 lakh shall have to submit by applicant in 1 month from approval of DPR</li>
