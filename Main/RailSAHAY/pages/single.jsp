...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="/RailSAHAY/resources//RailSAHAY/resources/fonts/flaticon/font/flaticon.css">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap" id="home-section">
      ...
      <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="site-logo">
              <a href="/RailSAHAY/index.jsp" class="text-black"><span class="text-primary">Cargo</a>
            </div>
            ...
            <div class="col-12">
              <nav class="site-navigation text-right ml-auto " role="navigation">
                ...
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                  <li><a href="/RailSAHAY/index.jsp#home-section" class="nav-link">Home</a></li>
                  <li><a href="/RailSAHAY/index.jsp#services-section" class="nav-link">Services</a></li>


                  <li class="has-children">
                    <a href="/RailSAHAY/index.jsp#about-section" class="nav-link">About Us</a>
                    <ul class="dropdown arrow-top">
                      <li><a href="/RailSAHAY/index.jsp#team-section" class="nav-link">Team</a></li>
                      <li><a href="/RailSAHAY/index.jsp#pricing-section" class="nav-link">Pricing</a></li>
                      <li><a href="/RailSAHAY/index.jsp#faq-section" class="nav-link">FAQ</a></li>
                      <li class="has-children">
                        <a href="#">More Links</a>
                        <ul class="dropdown">
                  ...
                  <li><a href="/RailSAHAY/index.jsp#why-us-section" class="nav-link">Why Us</a></li>

                  <li><a href="/RailSAHAY/index.jsp#testimonials-section" class="nav-link">Testimonials</a></li>
                  <li><a href="/RailSAHAY/index.jsp#blog-section" class="nav-link">Blog</a></li>
                  <li><a href="/RailSAHAY/index.jsp#contact-section" class="nav-link">Contact</a></li>
                </ul>
              </nav>
      ...
      <div class="site-section-cover overlay inner-page bg-light" style="background-image: url('/RailSAHAY/resources/images/cargo_sea_big.jpg')" data-aos="fade">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="/RailSAHAY/resources/images/person_2.jpg" alt="Image">
                  </div>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="/RailSAHAY/resources/images/person_3.jpg" alt="Image">
                  </div>
                  <div class="comment-body">
                    <h3>Chris Meyer</h3>
                    <div class="meta">January 9, 2018 at 2:21pm</div>
                  ...
                  <ul class="children">
                    <li class="comment">
                      <div class="vcard bio">
                        <img src="/RailSAHAY/resources/images/person_5.jpg" alt="Image">
                      </div>
                      <div class="comment-body">
                        <h3>Chintan Patel</h3>
                        <div class="meta">January 9, 2018 at 2:21pm</div>
                      ...
                      <ul class="children">
                        <li class="comment">
                          <div class="vcard bio">
                            <img src="/RailSAHAY/resources/images/person_1.jpg" alt="Image">
                          </div>
                          <div class="comment-body">
                            <h3>Jean Doe</h3>
                            <div class="meta">January 9, 2018 at 2:21pm</div>
                            ...
                            <ul class="children">
                              <li class="comment">
                                <div class="vcard bio">
                                  <img src="/RailSAHAY/resources/images/person_4.jpg" alt="Image">
                                </div>
                                <div class="comment-body">
                                  <h3>Ben Afflick</h3>
                                  <div class="meta">January 9, 2018 at 2:21pm</div>
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <img src="/RailSAHAY/resources/images/person_1.jpg" alt="Image" class="img-fluid mb-4 w-50 rounded-circle">
