...
<% strLastUpdate=Logg.setPortal(si_UserId,si_ClntId,si_Theme,si_LangFlag,"FREIGHT CALCULATOR","/RailSAHAY/pages/FindCmdtWgonFrgtCalc.jsp",UserDevice,Browser); %>
...
String si_FromWgonFlag      =   "";
if(null == request.getParameter("FromWgonFlag"))
    si_FromWgonFlag 	= (String)request.getAttribute("FromWgonFlag");
else 
    si_FromWgonFlag 	= (String)request.getParameter("FromWgonFlag");
...
String si_WgonType      =   "";
if(null == request.getParameter("txtWgonType"))
    si_WgonType 	= (String)request.getAttribute("txtWgonType");
else 
    si_WgonType 	= (String)request.getParameter("txtWgonType");
...
String si_CmdtName      = strCmdtName;
if(si_RakeSize == null)
    si_RakeSize =   "";
	int intDataSize 	=	0;
	int lastcount		=	-1;
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb"  style="background:#efefef;padding-left:10px;font-weight:600;">
    ...
    <%if(!si_FromWgonFlag.equals("")){%>
        <li class="breadcrumb-item" style="font-weight:600;"><a href="javascript:void(0)" onclick="showPage('CMDT_WGON_CTLG');"><%=si_WgonType%></a></li>
    <%}%>
    <li class="breadcrumb-item active" style="font-weight:600;" aria-current="page"><%=E.EH("Expected Freight Charges")%></li>
  </ol>
</nav>	
		...
		<h4 class="mb-2 subcmdthead" data-aos="fade-up" data-aos-delay="100" id="hSubCmdtHead"><%=GG_SubCmdtName%></h4>
              </div>
            </div>
           </div>
          </div>
...
<div class="col-sm-12" align="center">
					<div class="image-wrapper">
						...
						<h2 class="header-overlay-h2"><span class="statsfig wgontypefig" id="statwgontype"></span>&nbsp;Get to know about Expected Freight Charges and Estimate Transit Time for your freight transportation with Indian Railways</h2>
						<img src="/RailSAHAY/resources/images/industry/FC11.jpg" width="90%" class="img-responsive img-fluid" data-device-desktop="desktop" id="header-image" alt="">
					</div>					
			</div>	
</div></div>
<br/>
...
<div class="p-3 mb-2 mt-1 bg-white text-dark">
<form role="form-inline" action="/RailSAHAY/CmdtFrgtCalc" METHOD="post" id="frmFrgtC" name="frmFrgtC">
<div class="row" style="margin-left:5px;margin-right:5px;">
	<div class="col col-lg-3 col-md-3 col-sm-6 col-xs-6 padding-2" style="padding-right: 0px;padding-left: 0px;">
		...
		<div class="p-1 input-group">
                    <input type="text" list="cmdtlist" readonly  class="form-control inptcap" id="txtCmdtName" name="txtCmdtName"    onchange="clrscreen();fetchSchmList();fetchSttnFrom();fetchWgonList();fetchRakeCmdt();" required placeholder='<%=E.EH("Commodity Name")%>'  value='<%=si_CmdtName%>' autocomplete="off"   />
		...
		<div class="p-1 input-group">
                ...
                <div class="p-1">
                <%}%>
                    <input type="text" class="form-control inptcap" id="txtWgonType" required   name="txtWgonType"  value='<%=si_WgonType%>' readonly/>
                </div>
                <div class="p-1">
...
<input type="hidden" id="FromWgonFlag" name="FromWgonFlag" value="<%=si_FromWgonFlag%>"/>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-header">
                  <h5 class="modal-title" style="font-size:1rem;font-weight:600;margin:5px;color:#000;">Select Wagon</h5><h5 class="modal-title" id="hwgntype"></h5>
         ...
         <div class="modal fade" id="modalSchm">
            <div class="modal-dialog modal-dialog-centered mw-100 w-75">
              <div class="modal-content">
                ...
                <!-- Modal Header -->
                <div class="modal-header">
                  <h5 id="hdSchm" style="font-size:1rem;font-weight:600;margin:5px;color:#000;">Schemes</h5>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                
                <!-- Modal body -->
                <div class="modal-body">
                    <label style="font-size:12px;margin:4px;line-height:1.1;text-align:left;"><strong>Please Note:</strong> Latest Rate Circular, wherever available, should be read along with the Master Rate Circular.</label>
                    <div class="container">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                  <center><label style="font-size:12px;margin:4px;line-height:1.1;text-align:left;"><b>Legal Disclaimer:</b> While all efforts has been made for accuracy and updation, these Schemes are subject to change as per the instructions of Railway Board. For details/errors noticed, please contact the Railway Official at the nearest Goodshed.</label></center>
