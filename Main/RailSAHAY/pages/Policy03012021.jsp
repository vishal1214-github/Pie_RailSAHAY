			                        ...
			                        <div class="panel-body">
			                            <ul class="list-group list-group-flush">
										  ...
										  <li class="list-group-item">
											  ...
											  <p class="list-item-desc"> <%=E.EH("Are not being levied from 18.05.2020 to 31.10.2020")%></p>
										  ...
										  <li class="list-group-item">
											  ...
											  <p class="list-item-desc"> <%=E.EH("Has been given till 30.04.2021")%></p>
										  ...
										  <li class="list-group-item">
											  ...
											  <p class="list-item-desc"> <%=E.EH("For the traffic booked to and from notified alternate goods shed instead of busy goods shed. Terminal charge is otherwise levied at Rs.20 per tonne for goods sheds and PFTs")%></p>
										  ...
										  <li class="list-group-item">
											  ...
											  <p class="list-item-desc"> <%=E.EH("For loading of Pet Coke in Open wagons have been reduced, thereby, reducing the chargeable tonnage per wagon")%></p>
										  ...
										  <li class="list-group-item">
											  ...
											  <p class="list-item-desc"> <%=E.EH("With retrospective effect from new loading point Lingraj SILO siding of MCL (LSST) for movement of NTPC’s coal traffic over East Coast Railway")%></p>
			                    ...
			                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
			                        <div class="panel-body">
										<ul class="list-group list-group-flush">
										  ...
										  <li class="list-group-item">
											  <p class="list-item-head"><%=E.EH("23 pairs of two point combination for other than covered stock for steel traffic notified")%></p>
										  ...
										  <li class="list-group-item">
											  <p class="list-item-head"><%=E.EH("Minimum number of wagons in a rake reduced to 10 wagons for BCN under TEFD")%></p>
											  <p class="list-item-desc"> <%=E.EH("Minimum number of wagons in a rake reduced to 10 wagons for BCN under TEFD")%></p>
											  <p class="list-item-link"><a class="card-link1" href="http://indianrailways.gov.in/railwayboard/uploads/directorate/traffic_comm/Rates_Master_Circulars/2020/corr_2%20today.pdf" target="_blank"><%=E.EH("Corrigendum")%> (25.08.2020)..</a></p>
										  </li>
										  <li class="list-group-item">
											  <p class="list-item-head"><%=E.EH("Running of freight trains over seven CC+8 routes")%></p>
											  <p class="list-item-desc"> <%=E.EH("are included over Northern Railway")%></p>
										  ...
										  <li class="list-group-item">
											  ...
											  <p class="list-item-desc"> <%=E.EH("NMG rakes allowed with two point unloading destinations")%></p>
											  <p class="list-item-link"><a class="card-link1" href="http://indianrailways.gov.in/railwayboard/uploads/directorate/traffic_comm/Freight_Rate_2020/TCR_Multiple%20point_05082020.pdf" target="_blank"><%=E.EH("View Detail")%>..</a></p>
										  </li>
										</ul>
			                        </div>
