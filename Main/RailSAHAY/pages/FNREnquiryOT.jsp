...
<%
     ...
     String strFnrNumb1=   (String)request.getParameter("txtFnrNumb");
                    %>
<style>
.fnrmapdiv
{
...
<script defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDX-cwIo4xvSzjxyVRtxhoQy-KhLwRpgeM&callback=initMap&libraries=geometry&sensor=false" type="text/javascript"></script>
	          ...
	          <div class="col-lg-12">
	            <div class="box-shadow-content">
	              <div class="block-heading-1" style="margin-top:15px;">
	                <h3 class="mb-4" data-aos="fade-up" data-aos-delay="100"><%=E.EH("Status of your Consignment with FNR no")%>. <%=strFnrNumb1%></h3>
	              </div>
	            </div>
	           </div>
	          </div>
	...
	<div class="col-lg-4 col-sm-12">
 		<%
					...
					String strFNRNumb=(String)request.getParameter("txtFnrNumb");
