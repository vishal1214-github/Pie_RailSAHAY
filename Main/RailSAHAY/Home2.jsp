...
session.setAttribute("pageVisit", "index");
   ...
   %>
<%@ include file="/pages/GG_Header2.jspf" %>	
<% 
...
%>
      <div class="ftco-blocks-cover-1">
        <div class="ftco-cover-1 overlay" style="background-image: url('/RailSAHAY/resources/images/contbg.jpg')">
          <div class="container">
            <div class="row align-items-top" style="padding-top:130px;">
              <div class="col-lg-12" align="right">
                <h2><%=E.EH("WELCOME TO INDIAN RAILWAYS FREIGHT SERVICES")%></h2>
                <p class="mb-5"><%=E.EH("Simplifying your Freight Transportation and Logistics needs with Technology and Innovations")%>..</p>
	      <%--
	      <div class="row">
...
--%>
	      <div class="row">
	      <div class="col-lg-6 offset-lg-6 col-sm-12">	
		<input type="button" class="btn btn-primary text-white" style="width:210px;" value='<%=E.EH("New User Registration")%>' id="newReg" onclick="regUser()"/>
		<p class="mb-5"><%=E.EH("Register yourself for endless benefits")%> <strong><i class="fas fa-angle-right"></i>&nbsp;Learn More</strong></p>
	      </div>
	      </div>
            ...
            <div class="owl-carousel owl-all">
              <div class="service text-center" onclick="showPage('POLICY');">
                ...
                <div class="px-md-3">
                  ...
                  <p class="desc-text"><%=E.EH("Number of Schemes to make the transport more economical")%></p>
                </div>
              </div>
