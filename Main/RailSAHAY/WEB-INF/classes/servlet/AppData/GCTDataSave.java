	...
	public void doPost(HttpServletRequest req, HttpServletResponse	res) throws IOException
	{
		...
		if(si_Optn.equals("SAVE_DRAFT"))
		{
		    ...
		    logger.info("SAVE_DRAFT isMultiPart:-"+isMultiPart);
                    String strFileId="";
                    if(si_FileRfrnId.equals("") || (si_FileRfrnId==null))
                    {
                    ...
                    if(isMultiPart)
                    {
                        ...
                        {	
                                ...
                                */
                                ...
                                String strRfrnId=obj.saveGCTAppl("D", si_RfrnId, si_Dvsn, si_Trml, si_Name, si_Desg, si_GstIn, si_ApltType, si_FileRfrnId, si_CmdtCont, si_CmdtDtls);
                                logger.info("Service Call Status:"+obj.getCallStts());
