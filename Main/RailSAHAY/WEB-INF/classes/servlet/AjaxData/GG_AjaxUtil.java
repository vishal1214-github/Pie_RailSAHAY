...
public class GG_AjaxUtil extends HttpServlet
{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse	res) throws IOException
	{
		...
		if(si_DtlsType.equals("EMRKT_FCTY_LIST"))
		{
			logger.info("Case: E-Market Facilities List");
                        String strCtgr  = req.getParameter("Ctgr").toUpperCase().trim();
			resData=this.getEMrktFctyList(strCtgr);
		}
	...
	public String getEMrktFctyList(String si_Ctgr)
	{
		String strData="";
		logger.info("Entered in Terminal Facility List (getEMrktFctyList):"+si_Ctgr);
		...
		try
		{
			...
			RQFGAMISCQRY.setString("F_FLAG",		0,	"EMRKT_FCTY_LIST");
                        RQFGAMISCQRY.setString("F_FLAG",                1,      si_Ctgr);
		}
		catch(Exception e)
		{
			//logger.info"Error in Servlet : " + e);
