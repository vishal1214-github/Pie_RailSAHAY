...
//        custcode='';
	...
	htmlotsgpymt+='<div class="row"><div class="col-lg-4 col-sm-12"><p class="ctgr-title" style="margin-bottom:2px;">Rake Weighment Detail</p>';
        ...
        //alert("b ajax js");
      	//htmlotsgpymt+='<div class="row"><div class="col-lg-12 col-sm-12"><div class="table-responsive" style="min-height:100vh;max-height:100vh;overflow-y:auto;">' +
        //'<table class="table table-striped table-sm table-pymthstr" id="tblWgmtSmry">' +

        htmlotsgpymt+='<div class="col table-responsive" style="padding:0px;">'+
         '<table id="tblWgmtSmry"  style="line-height:6px;padding:1px;text-align: center" class="display table table-striped table-bordered tabformat table-sm table-mis">'+
       
        '<thead>' +
        '<tr class="p-stts">' +
        '<th colspan="4" class="center" >RAKE</th>' +
        '<th colspan="4" >WEIGHMENT</th>' +
        //'<th rowspan="1" style="width:20%;">STATION FROM</th>' +
        //'<th style="width:10%;">STATION TO</th><th style="width:20%;">TIME</th>' +
        //'<th rowspan="2" >NO. OF WAGONS</th>' +
        //'<th rowspan="2" >DETAIL</th>' +
        '</tr>' +
        '<tr class="p-stts">' +
        '<th style="white-space: nowrap;width:15%;"> ID</th>' +
        '<th >STATION FROM</th>' +
       '<th >STATION TO</th>' +
       '<th >CUSTOMER</th>' +
        '<th >STATION </th>' +
		...
		success : function(data) {
			...
			{                
                        //alert("inside");
                            ...
                            var customer=obj.CustWgmt[i].CustCode;
                           ...
                           htmlotsgpymt+='<td class="trxn-success" title="Click here to get weighment detail" style="white-space: nowrap;vertical-align: middle;"  onclick="showWgmtDetail1(\''+rakeid+'\',\''+wgmtid+'\',\''+sttn+'\',\''+datefrom+'\',\''+dateto+'\',\''+sttnfrom+'\',\''+sttnto+'\',\''+trxntime+'\',\''+wgmtcount+'\');"  >'+rakeid+' <i class="fas fa-info-circle"></i></td><td class="center" style="vertical-align: middle;">'+sttnfrom+'</td><td class="center" style="vertical-align: middle;" >'+sttnto+'</td><td class="center" style="vertical-align: middle;" >'+customer+'</td><td class="center" style="vertical-align: middle;" >'+sttn+'</td><td class="center" style="vertical-align: middle;" >'+vendor+'</td><td class="center" style="vertical-align: middle;" >'+trxntime+'</td><td class="center" style="vertical-align: middle;" >'+wgmtcount+'</td>';                           
                           htmlotsgpymt+='</tr>';
                          }
                          //alert("after for");
...
<nav class="navbar navbar-expand-sm bg-origprimary" style="margin-top:1px;max-height:10px;">
	  ...
	  <% } %>
          <li><a href="javascript:void(0)" class="db-link" onclick="raiseCncrn()"><i class="fas fa-angle-right"></i>&nbsp;Raise A Request</a></li>
            ...
            <% if(!strCustType.equals("S")) { %>
                <li  ><a href="javascript:void(0)" id="rakedtls" class="db-link" onclick="toggleOff();getCustWgmt('I','','','')"><i class="fas fa-angle-right"></i>&nbsp;Rake Weighment Detail</a></li>
            <% } %>
      ...
      <div class="container-fullwidth register1">
	    ...
	    <div class="col-lg-4 col-md-5 col-sm-12">
	      <form class="form-inline">
			...
			<td><button class="btn btn-success" style="height:25px;padding:1px;line-height:0.75" onclick="event.preventDefault();getCustWgmtData();">Find</button></td></tr></table>
  	      </form>
  	     </div>
	</nav>
             <div class="row">
...
("-"));
 ...
 function showWgmtDetail1(rakeid, wgmtid, sttn, datefrom, dateto, sttnfrom, sttnto, trxntime, wgmtcount)
	    {      
