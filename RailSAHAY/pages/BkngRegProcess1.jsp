	...
	<div class="container-fullwidth">
	  ...
	  <div class="stepwizard col-lg-10 offset-lg-1 col-sm-12">
	    ...
	    <form role="form" action="" method="post">
	      <div class="row setup-content" id="Booking">
		    ...
		    <button class="btn btn-primary prevBtn btn-sm pull-left" type="button">Previous</button>
	            <button class="btn btn-danger nextBtn btn-sm pull-right" type="button">Next</button>
	          </div>
	      </div>
		...
		<div class="col-lg-10 offset-lg-1 col-sm-12">
		  ...
		  <div class="container" style="margin-top:50px;">
			<h4><b><%=E.EH("3-Step Process for Registration")%></b></h4>
			<div class="list-group-flush">
			  <div class="list-group-item">
				<table class="table table-steplist">
				<tr>
			  ...
			  <div class="list-group-item">
	            ...
	            <button class="btn btn-success btn-sm pull-right" type="submit">Next</button>
		  </div>
		</div>
	      </div>
	    </form>
