...
%>
    ...
    function trackFNR() {
      ...
      <div class="ftco-blocks-cover-1">
        <div class="ftco-cover-1 overlay" style="background-image: url('/RailSAHAY/resources/images/bgfreight2.jpg')">
          <div class="container">
...
<a href="#imgTWU"><i class="fas fa-chevron-down fa-2x"></i></i></a>
</div>

        <!-- END .ftco-cover-1 -->
        <div class="ftco-service-image-1 pb-5">
          <div class="container" id="imgTWU">
            <div class="owl-carousel owl-all">
              ...
              <div class="service text-center" onclick="showPage('FRGT_CALC');">
                ...
                <div class="px-md-3">
                  <h3><a href="javascript:void(0)"><%=E.EH("Freight Calculator")%></a></h3>
          ...
          <div class="row mb-5 justify-content-center">
            <div class="col-md-7 text-center">
              <div class="block-heading-1">
                <h2><%=E.EH("What We Offer")%></h2>
                <p><%=E.EH("A one stop solution to all your needs, when it comes to Freight Transportation")%></p>
              </div>
            </div>
          </div>
          <div class="owl-carousel owl-all">
