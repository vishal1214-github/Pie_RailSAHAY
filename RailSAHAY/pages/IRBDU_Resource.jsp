...
<div class="inptdiv">
  ...
  <a class="btn-link" style="font-weight:600;font-size:13px;color:#b32400 !important;margin-left:1rem;" data-toggle="collapse" href="#uploadResFile" role="button" aria-expanded="false" aria-controls="collapseExample">
    <i class="fa fa-upload" aria-hidden="true"></i>&nbsp;&nbsp;Upload Resource File (*Excel Format)
  </a>
  </td>
</tr>
</table>
...
<td>
  ...
  <div class="card card-body">
    <form id="frmResFile" action="/RailSAHAY/AcqnPlanResUpload" onsubmit="onFormSubmit();" method="post" enctype="multipart/form-data">
         <h3 style="font-weight:600;color:#4d4d4d;font-size:14px;">Upload Resource(s) File <a href="/RailSAHAY/resources/demo/documents/IRBDU_ResourceTemplate.xlsx" target="samplefile" style="color:#b32400 !important;display:inline;cursor:pointer;">(*Download Sample Excel Format)</a></h3>
