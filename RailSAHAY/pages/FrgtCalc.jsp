...
<div class="row" style="margin-left:5px;margin-right:5px;">
	<div class="col col-lg-3 col-md-3 col-sm-6 col-xs-6 padding-2" style="padding-right: 0px;padding-left: 0px;">
		...
		<div class="p-1 input-group">
                ...
                <div class="p-1 input-group">
                    <input type="text" class="form-control inptcap name" id="txtSttnFrom"    name="txtSttnFrom" required placeholder='<%=E.EH("Station From")%>' value='<%=si_SttnFrom%>' autocomplete="off"/>
		...
		<div class="p-1 input-group">
                    <input type="text" class="form-control inptcap name" id="txtSttnTo"      name="txtSttnTo"    required placeholder='<%=E.EH("Station To")%>'  value='<%=si_SttnTo%>' autocomplete="off"/>
