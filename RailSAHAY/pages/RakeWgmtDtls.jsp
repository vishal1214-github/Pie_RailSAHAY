...
String FnrNumb=((String)request.getParameter("FnrNumb")).toUpperCase();
...
<script>
    ...
    {
        //alert("reeeady");
        fetchWgmtDetail('<%=WgmtRakeID%>','<%=WgmtID%>','<%=WgmtSttn%>','<%=WgmtdateFrom%>','<%=WgmtdateTo%>','<%=WgmtTime%>','<%=FnrNumb%>');
        //alert("readyyyy");
    });
</script>        
          ...
          <div class="col-lg-12" style="margin:1px;padding:1px;">
            ...
            <div class="box-shadow-content">
              <div class="block-heading-1" style="margin-top:5px;">
                <h3 data-aos="fade-up" data-aos-delay="100"><%=E.EH("CONSIGNMENT WEIGHMENT DETAIL")%></h3>
                <h6 data-aos="fade-up" data-aos-delay="100"><%=E.EH("RAKE ID: "+WgmtRakeID+"| FNR NUMBER: "+FnrNumb+"| STTN FROM: "+SttnFrom+"| STTN TO: "+SttnTo+"| WGMT STTN: "+WgmtSttn+"| WGMT TIME: "+WgmtTime+"| WAGON COUNT: "+WgmtCount)%></h6>
