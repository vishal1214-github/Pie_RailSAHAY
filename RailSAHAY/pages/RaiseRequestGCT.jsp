...
<div class="alert alert-success" id="sucsMesgDiv" style="display:none;width:400px;"></div>
	                                  ...
	                                  <div class="row register-form">
	                                      <div class="col-md-6">
	                                          ...
	                                          <div class="form-group">
	                                              <select  id="cncrctgr" tabindex="5" name="cncrctgr" class="form-control" required>
	                                                  <option value="GCT" selected>Gati Shakti Multi-Modal Cargo Terminal (GCT)</option>
	                                              </select>
	                                      ...
	                                      <div class="col-md-6">
	                                          ...
	                                          <div class="form-group">
	                                              <select id="subctgr" name="subctgr" tabindex="6" required class="form-control" onchange="chgSubCtgr()">
	                                                  <option value="H" selected>Application For Gati Shakti Multi-Modal Cargo Terminal (GCT)</option>
	                                              </select>
