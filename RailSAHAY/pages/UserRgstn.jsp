...
function hideMesg(){
    ...
    document.getElementById('sucsMesgDiv').style.display="none";
     ...
     <form class="form-horizontal" method="post"  autocomplete="off" action="/RailSAHAY/UserRgtn"  id="frmrgtn" name="frmrgtn" >
      <div class="container-fullwidth register">
	                  <div class="row">
	                      ...
	                      <div class="col-md-9 register-right">
	                          ...
	                          <h3 class="register-heading d-sm-none d-md-block d-lg-block d-xl-block">User Registration</h3>
                                <br/>
