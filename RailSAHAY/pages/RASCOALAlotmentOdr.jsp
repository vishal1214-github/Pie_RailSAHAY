...
<% 
strLastUpdate=Logg.setPortal(si_UserId,si_ClntId,si_Theme,si_LangFlag,"RAS COAL-ARREAR OF ALLOTMENTS (ODR WISE)","/RailSAHAY/pages/RASCOALAlotmentOdr.jsp",UserDevice,Browser);
	...
	<div class="container-fullwidth">
          ...
          <div class="col-lg-12">
            ...
            <div class="box-shadow-content">
              <div class="block-heading-1">
                <h3 class="mb-1" data-aos="fade-up" data-aos-delay="100"><%=E.EH("ARREAR OF ALLOTMENTS (ODR WISE)")%></h3>
	  ...
	  <div class="col-lg-2 col-md-2 col-sm-12 col-inpt">
	    ...
	    <div class="col-lg-4 col-md-4 col-sm-12 col-inpt">
        	...
        	<td>
        	<button class="btn btn-data float-left" onclick="event.preventDefault();fetchRASCoalAlotOdr();"><%=E.EH("Continue")%></button>
        	</td>
        	</tr>
        	</table>
	    </div>
