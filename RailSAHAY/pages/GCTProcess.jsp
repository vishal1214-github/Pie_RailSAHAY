...
<div class="card">
  ...
  <ul class="list-group list-group-flush">
	...
	<li class="list-group-item">Online apply <strong><a href="javascript:void(0);" onclick="showRaise();" class="card-link1" >here</a></strong> with complete details.</li>
	...
	<li class="list-group-item">Selection for the GCT (for entirely /partially Railway land) will be based on open tender. The tenders for which will be invited separately. </li>
...
<div class="card">
  ...
  <div class="card-body">
  <ul class="list-group list-group-flush">
    <li class="list-group-item">An Agreement for GCT shall be signed before the issue of commercial notification and operation of the GCT by Railway. Sr.DCM of the concerned Division shall be the signatory of the Agreement.</li>
