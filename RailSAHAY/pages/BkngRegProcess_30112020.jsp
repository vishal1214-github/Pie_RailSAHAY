        ...
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="row">		
				...
				<ul class="nav nav-pills">
				    <li class="nav-item">
				        <a class="nav-link active" data-toggle="tab" href="#Booking"><%=E.EH("Booking")%></a>
				    </li>
				    <li class="nav-item">
				        <a class="nav-link" data-toggle="tab" href="#Mvmt"><%=E.EH("Movement")%></a>
				    </li>
				    <li class="nav-item">
				        <a class="nav-link" data-toggle="tab" href="#Delivery"><%=E.EH("Delivery")%></a>
				    </li>
				    <li class="nav-item">
				        <a class="nav-link" data-toggle="tab" href="#Register"><%=E.EH("Registration Process")%></a>
				    </li>
				</ul>
				</div>
				<div class="optncard">
				<div class="tab-content">
				  <div class="tab-pane container fade" id="Register">
						  ...
						  <div class="container">
							<h4><b><%=E.EH("5-Step Process for Registration")%></b></h4>
							<div class="list-group-flush">
							  <div class="list-group-item">
								...
								<td>
									<p class="mb-0"><%=E.EH("Register yourself at Indian Railway's Freight Operations Information System Portal (FOIS)")%>. <a href="https://www.fois.indianrail.gov.in/foisEfnote/OpenPages/RgtrUserN.jsf" class="card-link1"  target="_blank"><%=E.EH("Visit Now")%>..</a> </p>
								</td>
								</tr>
								</table>
							  </div>
							  ...
							  <div class="list-group-item">
								<table class="table table-steplist">
								<tr>
								<td><button class="btn btn-step4">4</button></td>
								<td>
				  ...
				  <div class="tab-pane container active" id="Booking">
						 <div class="iconbgblue"><i class="far fa-edit fa-lg"></i></div>
							  <div class="container">
								<h4><b><%=E.EH("Booking Process")%></b></h4>
								<div class="list-group-flush">
				  ...
				  <div class="tab-pane container fade" id="Mvmt">
						 <div class="iconbggreen"><i class="fas fa-route fa-lg"></i></div>
							  <div class="container">
								<h4><b><%=E.EH("Freight Train Movement")%></b></h4>
								<div class="list-group-flush">
								  <div class="list-group-item">
									<table class="table table-steplist">
									<tr>
				  ...
				  <div class="tab-pane container fade" id="Delivery">
						 <div class="iconbgblue"><i class="fas fa-handshake fa-lg"></i></div>
							  <div class="container">
								<h4><b><%=E.EH("Delivery Process at Destination")%></b></h4>
								<div class="list-group-flush">
