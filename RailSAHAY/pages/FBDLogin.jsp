...
strLastUpdate=Logg.setPortal(si_UserId,si_ClntId,si_Theme,si_LangFlag,"FBD LOGIN","/RailSAHAY/pages/FBDLogin.jsp",UserDevice,Browser);
%>
<%
	String strMessage="";
        if((String)session.getAttribute("message")!=null)
            strMessage =(String)session.getAttribute("message");
...
<style>
body {
    background-image: url("/RailSAHAY/resources/images/owntrml1.jpg");
 ...
 function submitForm()
    ...
    if (err == 0) {
          ...
          /*  }else{
                   document.getElementById('errorMesgDiv').innerHTML="Please Enter Valid Username";
		   document.getElementById('errorMesgDiv').style.display="block";
                return false;
            }*/
		    ...
		    <div class="row">
		      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
		        <div class="card card-signin my-5">
		          <div class="card-body">
		            <h5 class="card-title text-center">APPLICANT LOG-IN FOR GCTO</h5>
		            <form action="/RailSAHAY/fbdlogin" name="frmLogin" id ="frmLogin"  method="post" >
		              ...
		              <!--div class="custom-control custom-checkbox mb-3">
		                ...
		                <label class="custom-control-label" for="customCheck1">Remember password</label>
                            ...
                            <tr>
                            <td class="align-left">
                            <a  class="btn btn-light btn-sm float-light" style="text-align:left" href="/RailSAHAY/pages/UserRgstn.jsp" target="_blank">Sign Up</a>
                            </td>
                            <td class="align-right">
                         <a  class="btn btn-light btn-sm float-light" style="text-align:right"  href="#" target="_blank">Forget Password</a
                            </td>
                            </tr>
                            </table>
                            </div>
