...
<nav class="navbar navbar-expand-sm bg-origprimary" style="margin-top:1px;max-height:10px;">
	  ...
	  <% } %>
          <li><a href="javascript:void(0)" class="db-link" onclick="raiseCncrn()"><i class="fas fa-angle-right"></i>&nbsp;Raise A Request</a></li>
            ...
            <% if(!strCustType.equals("S")) { %>
                <li  ><a href="javascript:void(0)" id="rakedtls" class="db-link" onclick="toggleOff();getCustWgmt('I','','','')"><i class="fas fa-angle-right"></i>&nbsp;Consignment Weighment Detail<img src="/RailSAHAY/resources/images/newiconblink2.gif" style="width:40px;height:27px;"></a></li>
            <% } %>
