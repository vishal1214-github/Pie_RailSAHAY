...
strLastUpdate=Logg.setPortal(si_UserId,si_ClntId,si_Theme,si_LangFlag,"UNLOADING LOCATIONS","/RailSAHAY/pages/UldgLocn.jsp",UserDevice,Browser);
%>
...
<script src="/RailSAHAY/resources/js/locnmapview.js"></script>
	...
	<div class="container-fullwidth">
          ...
          <div class="col-lg-12">
            ...
            <div class="box-shadow-content">
              <div class="block-heading-1" style="margin-top:15px;">
                <h3 class="mb-4" data-aos="fade-up" data-aos-delay="100"><%=E.EH("LIST OF UNLOADING LOCATIONS")%></h3>
              </div>
            </div>
           </div>
          </div>
	  ...
	  <div class="col-lg-2 col-md-3 col-sm-12">
          <input class="form-control mr-sm-2 inptcap" list="cmdtlist" id="txtCmdt"  name="txtCmdt" type="text" onchange="maphide()"  placeholder='<%=E.EH("Commodity")%>'>	
	  ...
	  <div class="col-lg-2 col-md-3 col-sm-12">
	    ...
	    <div class="col-lg-4 col-md-5 col-sm-12">
	      <form class="form-inline">
	          <table><tr><td><input class="form-control mr-sm-2 inptcap" list="locnlist" id="txtLocn" name="txtLocn" type="text" placeholder='<%=E.EH("Search")%>'>
		  <datalist id="locnlist"></datalist>
		</td><td><button class="btn btn-data" onclick="event.preventDefault();fetchLocnList('ULDG');mapshow();"><%=E.EH("Search")%></button>&nbsp;&nbsp;&nbsp;<span id="mapIm" class="float-right"> <img src="/RailSAHAY/resources/images/crntflag.png" onclick="initMapL(); " data-toggle="modal" data-target="#mapModal" onmouseover="this.style.cursor='pointer';" alt='<%=E.EH("View on Map")%>' title='<%=E.EH("View on Map")%>'  ></span></td></tr></table>
  	      </form>
  	     </div>
	</nav>
          <div class="row">
