<%@ include file="/pages/GG_Header.jspf" %>
  ...
  <div id="wrapper">
       ...
       <!-- Heading -->
            ...
            <li class="nav-item">
              <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#category" aria-expanded="true" aria-controls="collapseTwo">
                ...
                <span><%=E.EH("Freight Business")%></span>
              </a>
              <div id="category" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                  <h6 class="collapse-header">Select Category:</h6>
                  <a class="collapse-item" href="buttons.html">Booking</a>
                  <a class="collapse-item" href="cards.html">Payments</a>
                  <a class="collapse-item" href="cards.html">Freight & Other Charges</a>
                  <a class="collapse-item" href="cards.html">Policies & Rules</a>
                  <a class="collapse-item" href="cards.html">Freight Operations Information system (FOIS)</a>
                  <a class="collapse-item" href="cards.html">How to Reach Us</a>
                </div>
              </div>
      </li>
	...
	<div class="form-check chkfilter">
	  	<input class="form-check-input chksmart" type="checkbox" name="chkSMARTFcty" value="A" id="chkAggr">
		<label class="form-check-label" for="chkAggr">
    		<%=E.EH("Aggregator")%>
		</label>
	</div>
	<div class="form-check chkfilter">
	  	<input class="form-check-input chksmart" type="checkbox" name="chkSMARTFcty" value="T" id="chkTrck">
		<label class="form-check-label" for="chkTrck">
    		<%=E.EH("Trucker")%>
		</label>
	</div>
	<div class="form-check chkfilter">
	  	<input class="form-check-input chksmart" type="checkbox" name="chkSMARTFcty" value="W" id="chkWH">
		<label class="form-check-label" for="chkWH">
    		<%=E.EH("Warehouse")%>
		</label>
	</div>
	<div class="form-check chkfilter">
	  	<input class="form-check-input chksmart" type="checkbox" name="chkSMARTFcty" value="L" id="chkLab">
