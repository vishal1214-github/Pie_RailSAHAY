weigh	<%@ include file="/pages/GG_Header.jspf" %>
 ...
 function getCustWgmt(inptrxnid, fromdate, todate, sttncode)
{
	...
	htmlotsgpymt+='<div class="row"><div class="col-lg-12 col-sm-12"><p class="ctgr-title" style="margin-bottom:2px;">Consignment Weighment Detail</p>';
        ...
        '<th colspan="5" class="center" >CONSIGNMENT</th>' +
       ...
       '<th >CONSIGNOR</th>' +
        ...
        //'<th >VENDOR</th>' +
        '<th >TIME</th>' +
        '<th style="width:15%;">NO. OF LOADED WAGONS</th>' +
        '</tr>' +        
...
<nav class="navbar navbar-expand-sm bg-origprimary" style="margin-top:1px;max-height:10px;">
	  ...
	  <% } %>
          <li><a href="javascript:void(0)" class="db-link" onclick="raiseCncrn()"><i class="fas fa-angle-right"></i>&nbsp;Raise A Request</a></li>
            ...
            <% if(!strCustType.equals("S")) { %>
                <li  ><a href="javascript:void(0)" id="rakedtls" class="db-link" onclick="toggleOff();getCustWgmt('I','','','')"><i class="fas fa-angle-right"></i>&nbsp;Consignment Weighment Detail<img src="/RailSAHAY/resources/images/newiconblink2.gif" style="width:50px;height:27px;"></a></li>
            <% } %>
      ...
      <div class="container-fullwidth register1">
	    ...
	    <div class="col-lg-4 col-md-5 col-sm-12">
	      <form class="form-inline">
			...
			<td>
                            <input type="text" class="form-control"  id="txtCustSttn" name="txtCustSttn"  style="text-transform:uppercase;height:25px;padding:1px;" required="required" list="custsttnlist" placeholder="Weighment Station " value=""  size="20" >
