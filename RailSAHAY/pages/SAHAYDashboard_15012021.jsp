	...
	htmlotsgpymt+='<div class="row"><div class="col-lg-12 col-sm-12"><p class="ctgr-title" style="margin-bottom:2px;">Rake Weighment Detail</p>';
       ...
       '<th >CNSR</th>' +
        ...
        '<th >STATION </th>' +
         '<th >VENDOR</th>' +
        '<th >TIME</th>' +
        '<th style="white-space: nowrap;">NO. OF LOADED WAGONS</th>' +
        '</tr>' +        
        '</thead><tbody><tr></tr>';
		...
		success : function(data) {
			...
			{                
                        ...
                        j=i+1;
                           ...
                           htmlotsgpymt+='<td class="center" style="vertical-align: middle;">'+j+'</td><td class="trxn-success" title="Click here to get weighment detail" style="white-space: nowrap;vertical-align: middle;"  onclick="showWgmtDetail1(\''+rakeid+'\',\''+wgmtid+'\',\''+sttn+'\',\''+datefrom+'\',\''+dateto+'\',\''+sttnfrom+'\',\''+sttnto+'\',\''+trxntime+'\',\''+wgmtcount+'\');"  >'+fnrnumb+' <i class="fas fa-info-circle"></i></td><td class="center" style="vertical-align: middle;">'+sttnfrom+'</td><td class="center" style="vertical-align: middle;" >'+sttnto+'</td><td class="center" style="vertical-align: middle;" >'+cnsr+'</td><td class="center" style="vertical-align: middle;" >'+cnsg+'</td><td class="center" style="vertical-align: middle;" >'+sttn+'</td><td class="center" style="vertical-align: middle;" >'+vendor+'</td><td class="center" style="vertical-align: middle;white-space: nowrap;" >'+trxntime+'</td><td class="center" style="vertical-align: middle;" >'+wgmtcount+'</td>';                           
                           htmlotsgpymt+='</tr>';
                          }
                          //alert("after for");
