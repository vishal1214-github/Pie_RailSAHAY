...
%>
	...
	<div class="card mr-3 ml-3">
	  ...
	  <div class="card-body">
		   ...
		   <li><b style="color:#000;"><%=E.EH("Gati-Shakti Multimodal Cargo Terminal (GCT)")%></b> <%=E.EH("Gati-Shakti Multimodal Cargo Terminals of railways will be terminals where different modes of transportation will be integrated seamlessly with the railway transportation network.With introduction of GCT policy in December 2021 by Indian Railways, the Private sidings as well as PFTs will be governed by GCT policy. The GCT will be set up by private logistics partners under the <strong><a href=\"/RailSAHAY/resources/pdf/GCTO_Policy.pdf\" class=\"card-link1\" target=\"gctpolicy\">GCT Policy</a></strong>")%>
		   <%--<br/>
		   <b style="color:#000;"><%=E.EH("What is Gati-Shakti Multimodal Cargo Terminal")%></b> <br/><%=E.EH("1.1 This policy seeks to promote proliferation of new Cargo Terminals and improve existing Cargo Terminals to accelerate the growth in Railways cargo traffic. All new as well as under-construction/under-approval Cargo Terminals (approved/proposed under Private Siding or Private Freight Terminal policies) shall be covered by this Gati Shakti Multi-Modal Cargo Terminal (GCT) policy")%>.<br/><%=E.EH("1.2 Existing Cargo Terminals, governed by Private Siding or Private Freight Terminal policies, shall have the option to continue with their existing Agreements, or to migrate to this new GCT policy")%>.<!--<br/><p style="font-weight:600;color:#000;">Check eligibility for GCT Operators (GCT) <a href="javascript:void(0)" onclick="showPage('GCT_ELGB');" style="font-weight:600;color:#b32400;">here </a></p>--></li>
			--%>
		   </ul>
