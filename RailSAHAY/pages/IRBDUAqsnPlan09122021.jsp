    ...
    <div class="row">
        <div class="col-md-12">
            <ul id="tabs" class="nav nav-tabs">
                ...
                <li class="nav-item"><a href="" data-target="#step8" data-toggle="tab" class="nav-link small text-uppercase">Initiatives Taken</a></li>
		<li class="nav-item">
			 <div class="btn-group">
			  ...
			  <div class="dropdown-menu">
                ...
                <li class="nav-item"><a href="" data-target="#step11" data-toggle="tab" class="nav-link small text-uppercase">Target Growth Areas</a></li>
            </ul>
            <br>
