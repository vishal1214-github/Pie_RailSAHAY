...
<style>
	...
	var GG_SelCustCtgr="";
<% for(int i=0;i<psorgList.size();i++) {%>
	console.log('<%=psorgList.get(i).get(0)%>-<%=psorgList.get(i).get(1)%>');
<% } %>
...
<nav class="navbar navbar-expand-sm bg-origprimary" style="margin-top:1px;max-height:10px;">
      ...
      <div class="page-content d-flex align-items-stretch">
	    ...
	    <li><a href="javascript:void(0)" class="db-link" onclick="fetchSecCust()"><i class="fas fa-angle-right"></i>&nbsp;My Secondary Customers<img src="/RailSAHAY/resources/images/newiconblink2.gif" style="width:50px;height:27px;"></a></li>
	  
            <li><a href="javascript:void(0)" class="db-link" onclick="fetchChrg('')"><i class="fas fa-angle-right"></i>&nbsp;Pending Payments <img src="/RailSAHAY/resources/images/newiconblink2.gif" style="width:50px;height:27px;"></a></li>
...
<td>
  <div class="jumbotron bg-white">
    <div class="df-switch">
      <button type="button" class="btn btn-lg btn-toggle" data-toggle="button" aria-pressed="false" autocomplete="off" id="btnPrimSec">
...
--%>
		...
		<!-- Item -->
		  ...
		  <img src="/RailSAHAY/resources/images/cornerribbon.png" style="position:absolute;top:-15px;left:-20px;" />
                  <div class="item d-flex align-items-center" onclick="fetchChrg('');">
	          ...
	          <table style="width:80%">
	          	...
	          	<td style="width:40%" >
			          ...
			          <datalist id="orgseclist"></datalist>
                        ...
                        <td style="width:20%" ><input class="form-control mr-sm-2 inptcap numb" id="txtMoblNumb" size="10"  name="txtMoblNumb" type="text" maxlength="10"  placeholder='<%=E.EH("Mobile Number")%>'>
				 
			</td>
                        <td style="width:30%" ><input class="form-control mr-sm-2 inptcap" id="txtEmailId" name="txtEmailId" size="30" type="text"  placeholder='<%=E.EH("EmailId")%>'>
	...
	<div class="col-lg-6 col-sm-12" style="overflow:auto;" id="divUserDtlsPnl">
		<!--<div class="optncard">
				  ...
				  <div class="tab-pane container active" id="Schd">
					<div id="divUserDtls" class="trmllistdata mr-2 timeline-centered"></div>
                                       ...
                                       <!--  <td><button id="butadd" onclick="addRow();" >Add</button><br>
                                        ...
                                        <center><button class="btn btn-outline-primary btn-sm" style="padding: 0.1rem 0.3rem;" title="Save Secondary Customer" onclick="savedata();"><i class="fas fa-save"></i></button><button onclick="fetchSecCust()">Cancel</button></center>
