		   ...
		   <% if(strLognLocnFlag.equals("D")) { %>
			...
			<th>Consignor(s)</th>
                ...
                <div id="step5" class="tab-pane fade">                    
                    ...
                    <p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp;Action Plan to augment loading and diversify Rishabh commodity basket</p>
                    <table class="table table-input table-striped table-bordered">
                    <thead>
		    <tr>
                        <th>Division</th>
                        <th>Action Plan with Deadline Rishabh</th>
