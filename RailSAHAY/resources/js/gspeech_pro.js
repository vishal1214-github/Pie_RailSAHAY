...
$(document).ready(function() {
	...
	$("#audio_tooltip").mousedown(function(e){
		return false;
	});
	...
	function hide_speaker() {
		...
		hide_tooltip_basic($('#audio_tooltip'));
	};
	...
	function check_pro_version() {
		return true;
		var bl = $("#audio_tooltip").css("display");
		var bl1 = $("#audio_tooltip .tooltip_inner").css("display");
		if(bl == 'block' && bl1 == 'block') 
			return true;
		return false;
	};
	
	$("#audio_tooltip").mouseup(function(e){
		return false;
	});
	...
	$("#sound_container").hover(function() {
		...
		navigate_tooltip_basic($('#audio_tooltip_title'),sound_x,sound_y);
	},function() {
		var sound_x = parseFloat($(this).css('left'));
		var sound_y = parseFloat($(this).css('top'));
		hide_tooltip_basic($('#audio_tooltip_title'),sound_x,sound_y);
	});
	...
	function move_sound_container(x,y,txt) {
		...
		navigate_tooltip_basic($('#audio_tooltip'),sound_x,sound_y);
	};
	...
	function make_audio() {
		...
		//alert(selected_txt);
	var msg = new SpeechSynthesisUtterance(selected_txt);
