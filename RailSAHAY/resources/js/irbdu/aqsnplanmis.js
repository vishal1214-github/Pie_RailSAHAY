            ...
            {        
				...
				case 'CMDT_RAIL_COST' :
				    ...
				    htmlstr+='<th>Additional Costs (Per Ton)</th>';
                                    ...
                                    htmlstr+='</table>';
                                    $("#step1").html(htmlstr);   
                                    printTable("example1","ZONAL ACTION PLANS: RAIL COST","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
                                    break;
		       			case 'CMDT_ROAD_COST' :
					...
					htmlstr+='</table>';
					$("#step2").html(htmlstr);
                                        printTable("example2","ZONAL ACTION PLANS: ROAD COST","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
					break;
		       			case 'CNSR_WISE_INFO' :
			       		...
			       		htmlstr='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Building a marketing strategy for Bulk and non-Bulk commodities</p>';
								...
								htmlstr+='</table>';
							$("#step4").html(htmlstr);	
							printTable("example4","ZONAL ACTION PLANS: INDUSTRY CLUSTER","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
                                                        break;
			       		...
			       		htmlstr='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Action Plan to augment loading and diversify commodity basket</p>';
								...
								htmlstr+='</table>';
							$("#step5a").html(htmlstr);	
							printTable("example5","ZONAL ACTION PLANS: ACTION PLAN","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
                                                        break;
		       			case 'FF_CRNT' :
			       		htmlstr='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Freight Forwarders, Aggregators and Logistics Partners (Current)</p>';
								...
								htmlstr+='</table>';
							$("#step6").html(htmlstr);	
							printTable("example6","ZONAL ACTION PLANS: FREIGHT FORWARDERS (CURRENT)","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
                                                        break;
							
		       			case 'FF_PROPOSED' :
			       		htmlstr='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Freight Forwarders, Aggregators and Logistics Partner (Proposed)</p>';
								...
								htmlstr+='</table>';
							$("#step7").html(htmlstr);	
							printTable("example7","ZONAL ACTION PLANS: FREIGHT FORWARDERS (PROPOSED)","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
                                                        break;
			       		...
			       		htmlstr='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp;  Cross learning from Zones: Initiatives taken to boost traffic in year ending March 31, 2021 and to date</p>';
								...
								htmlstr+='</table>';
							$("#step8").html(htmlstr);	
							printTable("example8","ZONAL ACTION PLANS: INITIATIVES TAKEN","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
                                                        break;
			       		...
			       		htmlstr='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp;  SWOT Analysis</p>';
								...
								htmlstr+='</table>';
							$("#step9").html(htmlstr);	
							printTable("example9","ZONAL ACTION PLANS: SWOT ANALYSIS","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
                                                        break;
			       		...
			       		htmlstr='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp;  Industry Outreach for Zone/Division</p>';
								...
								for(var i=0;i<obj.DataList1.length;i++)
								{
									...
									htmlstr+='<tr><td>'+INDS_OUTREACH[i][0]+'</td><td>'+INDS_OUTREACH[i][1]+'</td><td>'+INDS_OUTREACH[i][2]+'</td><td>'+INDS_OUTREACH[i][3]+'</td><td>'+INDS_OUTREACH[i][4]+'</td><td>'+INDS_OUTREACH[i][5]+'</td><td>'+INDS_OUTREACH[i][6]+'</td><td>'+INDS_OUTREACH[i][7]+'</td><td>'+INDS_OUTREACH[i][8]+'</td><td>'+INDS_OUTREACH[i][9]+'</td></tr>';
								} 
								htmlstr+='</table>';
							$("#step10").html(htmlstr);	
							printTable("example10","ZONAL ACTION PLANS: INDUSTRY OUTREACH","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
                                                        break;							
			       		...
			       		htmlstr='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp;  Target Areas for Rail Co-efficient Boost and Gati-Shakti</p>';
								...
								for(var i=0;i<obj.DataList1.length;i++)
								{
									...
									htmlstr+='<tr><td>'+RAIL_COEF_BOOST[i][0]+'</td><td>'+RAIL_COEF_BOOST[i][1]+'</td><td style="background:#ccffcc;">'+formatMultVals(RAIL_COEF_BOOST[i][2])+showOtherVal(RAIL_COEF_BOOST[i][3])+'</td><td style="background:#ccffcc;" class="other-col">'+RAIL_COEF_BOOST[i][3]+'</td><td style="background:#fff0b3;">'+formatMultVals(RAIL_COEF_BOOST[i][4])+showOtherVal(RAIL_COEF_BOOST[i][5])+'</td><td style="background:#fff0b3;" class="other-col">'+RAIL_COEF_BOOST[i][5]+'</td><td style="background:#ffcccc;">'+formatMultVals(RAIL_COEF_BOOST[i][6])+showOtherVal(RAIL_COEF_BOOST[i][7])+'</td><td style="background:#ffcccc;" class="other-col">'+RAIL_COEF_BOOST[i][7]+'</td><td><a href="javascript:void(0)" onclick="downloadTrfcPlan(\''+RAIL_COEF_BOOST[i][9]+'\');" style="color:#b32400 !important;font-weight:600;">'+RAIL_COEF_BOOST[i][8]+'</a></td></tr>';
								} 
								htmlstr+='</table>';
							$("#step11").html(htmlstr);	
							printTable("example11","ZONAL ACTION PLANS: TARGET GROWTH AREAS","ZONE: "+zone+", DIVISION: "+dvsn+", COMMODITY: "+cmdt);
                                                        break;
		       			case 'ZONL_PERF' :
