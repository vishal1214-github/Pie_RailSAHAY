...
function gnrtRadarChart()
{
  ...
  datasets: [{
    label: 'Total Freight Generation',
    ...
    label: 'Rail Coefficient',
    data: [28, 48, 40, 19, 22, 27, 38],
    fill: true,
    backgroundColor: 'rgba(54, 162, 235, 0.2)',
    borderColor: 'rgb(54, 162, 235)',
    pointBackgroundColor: 'rgb(54, 162, 235)',
...
var ctx = document.getElementById('cmdtRailCoef1').getContext('2d');

  	if (cmdtRailCoefChrt1 !=undefined) {
		cmdtRailCoefChrt1.destroy();
  	}

	var canvas = document.getElementById("cmdtRailCoef1");
	var $td = $('#cmdtRailCoef1').parent();
	canvas.width = $td.width();
	canvas.height = $td.height();

			var cmdtRailCoefChrt1 = new Chart(ctx, config);
cmdtRailCoefChrt1.options.legend.display = false; 
}