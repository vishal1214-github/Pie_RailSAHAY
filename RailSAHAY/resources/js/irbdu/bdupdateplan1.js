...
function infoHelpMesg(catgr)
{
	...
	if(catgr=='CMDT_ROAD_COST')
	{
		...
		htmlstr+='<li class="list-group-item">The division has to entered the <u>“per ton per km cost”</u> of Road for the selected commodity which will be inclusive of all taxes and additional charges as applicable for the comparison of Railway rates. </li>';
	...
	if(catgr=='CNSR_WISE_INFO')
	{
		...
		htmlstr+='<li class="list-group-item">In case of selecting “Other” from the given options under Industry of freight generation list, then specific details needs to be mentioned under detail of industry column. The said column will only be activated once “Other” is selected from the list.</li>';
	...
	if(catgr=='SWOT_ANLY')
	{
		...
		htmlstr+='<li class="list-group-item">Select the “Opportunity” for Railway in particular division or zone from the given options.</li>';
		htmlstr+='<li class="list-group-item">Select the “Threats” for Railway in particular division or zone from the given options.</li>';
		htmlstr+='<li class="list-group-item">In case of selecting “Other” from the given options, the details need to be mentioned under the head of “any other strength”.   The said column will only be activated once “Other” is selected from the list. It is similarly used for Weaknesses, Opportunities and Threat.</li>';
	...
	{
		htmlstr+='<li class="list-group-item">Select the areas by which “Immediate Growth” is expected in respective division or zone by the given options.</li>';
		htmlstr+='<li class="list-group-item">Select the areas by which “Medium Term Growth” is expected in respective division or zone by the given options.</li>';
		htmlstr+='<li class="list-group-item">Select the areas by which “Long Term Growth” is expected in respective division or zone by the given options.</li>';
		htmlstr+='<li class="list-group-item"><strong>Save</strong> the data and add more by using the same method.</li>';
	...
	if(catgr=='RDRSS_DVNL_PROP')
	{
		...
		htmlstr+='<li class="list-group-item">In case of decision, a decision letter need to be uploaded the clicking the button for “choose file” and title/subject of the decision letter need to be mentioned under subject/remark column.</li>';
...
function addRecord(inpt_ctgr)
{
	...
	switch(inpt_ctgr)
	{
		...
		case 'CMDT_RAIL_COST' :
			content='<div class="form-title text-center">';
					  content+='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp;Overview of all freight commodities with their Rail Transportation Costs</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
					content+='</div>';
					content+='<div class="d-flex flex-column text-center" id="divInptForm">';
		...
		case 'CMDT_ROAD_COST' :
			content='<div class="form-title text-center">';
					  content+='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp;Overview of all freight commodities with their Comparative Road Transportation Costs</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
					content+='</div>';
					content+='<div class="d-flex flex-column text-center" id="divInptForm">';
					content+='<form>';
					    content+='<div class="row">';
				...
				case 'END_MILE_COST':
  				...
  				case 'CNSR_WISE_INFO':
  					content='<div class="form-title text-center">';
					  content+='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Granular information Consignor Wise with the name of Industry/consignor</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
					content+='</div>';
					content+='<div class="d-flex flex-column text-center" id="divInptForm"> ';
					  content+='<form>';
					    content+='<div class="form-group">';
  			...
  			case 'MKTG_STRT_BULK':
  					content='<div class="form-title text-center">';
				  content+='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Building a Marketing Strategy for Bulk & Non-Bulk Commodities</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
				content+='</div>';
				content+='<div class="d-flex flex-column text-center" id="divInptForm"> ';
				  content+='<form>';
				    content+='<div class="form-group">';
  			...
  			case 'AGMT_LDNG1':
  				content='<div class="form-title text-center">';
					  content+='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Action plan to augment loading and diversify commodity basket</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
					content+='</div>';
					content+='<div class="d-flex flex-column text-center" id="divInptForm"> ';
					  content+='<form>';
					    content+='<div class="row">';
  			...
  			case 'FF_CRNT':
  				content='<div class="form-title text-center">';
				  content+='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Freight Forwarders, Aggregators and Logistics Partners (Current)</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
				content+='</div>';
				content+='<div class="d-flex flex-column text-center" id="divInptForm"> ';
				  content+='<form>';
				    content+='<div class="form-group">';
  		...
  		case 'FF_PROPOSED':
  			content='<div class="form-title text-center">';
				  content+='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Freight Forwarders, Aggregators and Logistics Partners (Proposed)</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
				content+='</div>';
				content+='<div class="d-flex flex-column text-center" id="divInptForm"> ';
				  content+='<form>';
				    content+='<div class="form-group">';
  		...
  		case 'INIT_TRFC_BOOST':
  			content='<div class="form-title text-center">';
				  content+='<p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Cross learning from Zones: Initiatives taken to boost traffic in year ending March 31, 2021 and to date</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
				content+='</div>';
				content+='<div class="d-flex flex-column text-center" id="divInptForm">';
				  content+='<form>';
				    content+='<div class="row">';
  			...
  			case 'SWOT_ANLY':
  				content='<div class="form-title text-center">';
				content+=' <p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; SWOT Analysis</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
				content+='</div>';
				content+='<div class="d-flex flex-column text-center" id="divInptForm"> ';
				content+='<form>';
					    content+='<div class="form-group">';
  			...
  			case 'INDS_OUTREACH':
  				content='<div class="form-title text-center">';
				content+=' <p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Industry Outreach</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
				content+='</div>';
				content+='<div class="d-flex flex-column text-center" id="divInptForm"> ';
				content+='<form>';
				    content+='<div class="form-group">';
  			...
  			case 'RAIL_COEF_BOOST':
  				content='<div class="form-title text-center">';
				content+=' <p class="tab-head-caption"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Target Areas for Rail Co-efficient Boost and Gati-Shakti</p><span onclick="infoMesg(\''+inpt_ctgr+'\');" class="pull-left help-icon"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;How to Feed !</span>';
				content+='</div>';
				content+='<div class="d-flex flex-column text-center" id="divInptForm"> ';
				content+='<form>';
				    content+='<div class="form-group">';
