...
public class VldtMobile extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //  System.out.println("Inside chkAvailability" + tavcustuserid);
        ...
        System.out.println("Reached in Server::"+mobile);
        try {
            currentCon = dbConnection.getConnection();
             ps =
                currentCon.prepareStatement("SELECT count(1) EXST FROM TEM_FBDCUSTLGIN WHERE  TANCUSTMOBLNUMB =? AND SUBSTR(TAVCUSTSTTS,2,1) NOT IN ('N','D','S') ");
