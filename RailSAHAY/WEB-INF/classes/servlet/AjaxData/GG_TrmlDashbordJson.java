	...
	public void doPost(HttpServletRequest req, HttpServletResponse	res) throws IOException
	{
		...
		if(si_Optn.equals("SMRY_STATS"))
		{
				...
				String si_Lng	= req.getParameter("Lng").toUpperCase().trim();
                                String si_TrmlFcty   = req.getParameter("TrmlFcty").toUpperCase().trim();
                                String si_SMARTFcty   = req.getParameter("SMARTFcty").toUpperCase().trim();
				logger.info("LocnType:"+si_LocnType+", Locn:"+si_Locn+", Cmdt:"+si_Cmdt+", Lat:"+si_Lat+", Lng:"+si_Lng+", TrmlFcty:"+si_TrmlFcty+", SMARTFcty:"+si_SMARTFcty);
				...
				try
				{
						String strSrvcData[];
						String strData="";
						strSrvcData=obj.getSmryStats(si_LocnType, si_Locn, si_Cmdt, si_Lat, si_Lng, si_TrmlFcty, si_SMARTFcty);
		...
		if(si_Optn.equals("TRML_LIST"))
		{
				...
				String si_TrmlType	= req.getParameter("TrmlType").toUpperCase().trim();
                                String si_TrmlFcty      = req.getParameter("TrmlFcty").toUpperCase().trim();
                                String si_SMARTFcty      = req.getParameter("SMARTFcty").toUpperCase().trim();
				logger.info("LocnType:"+si_LocnType+", Locn:"+si_Locn+", Cmdt:"+si_Cmdt+", Lat:"+si_Lat+", Lng:"+si_Lng+", TrmlType:"+si_TrmlType+", si_TrmlFcty:"+si_TrmlFcty+", si_SMARTFcty:"+si_SMARTFcty);
				...
				try
				{
						String strSrvcData[][];
						String strData="";
						strSrvcData=obj.getTrmlList(si_LocnType, si_Locn, si_Cmdt, si_Lat, si_Lng, si_TrmlType, si_TrmlFcty, si_SMARTFcty);
						String strCallStts=obj.getCallStts();
						String strCallMesg=obj.getCallMesg();
		...
		if(si_Optn.equals("BRKUP_STATS"))
		{
				...
				String si_Cmdt		= req.getParameter("Cmdt").toUpperCase().trim();
                                String si_TrmlFcty      = req.getParameter("TrmlFcty").toUpperCase().trim();
                                String si_SMARTFcty      = req.getParameter("SMARTFcty").toUpperCase().trim();
				logger.info("si_TrmlType:"+si_TrmlType+", si_BrkType:"+si_BrkType+", Cmdt:"+si_Cmdt+", TrmlFcty:"+si_TrmlFcty+", SMARTFcty:"+si_SMARTFcty);
				...
				try
				{
						String strSrvcData[][];
						String strData="";
						strSrvcData=obj.getBrkUpList(si_BrkType, si_TrmlType, si_Cmdt, si_TrmlFcty, si_SMARTFcty);
						String strCallStts=obj.getCallStts();
						String strCallMesg=obj.getCallMesg();
