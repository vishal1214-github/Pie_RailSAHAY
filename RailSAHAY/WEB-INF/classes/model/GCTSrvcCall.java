...
public class GCTSrvcCall
{
    ...
    public String saveGCTAppl(String si_ApplMode, String si_RfrnId, String si_Dvsn, String si_Sttn, String si_Name, String si_Desg, String si_Mobl, String si_ContNo, String si_Email, String si_Addr, String si_PAN, String si_TAN, String si_GstIn, String si_ApltType, String si_FileRfrnId, String si_CmdtCont, String si_CmdtDtls)
    {
            String strRfrnId="";
            ...
            try
            {
                    ...
                    RTSAVEGCTO.setString("F_ORDRBY9",              1,      si_Mobl);
                    RTSAVEGCTO.setString("F_ORDRBY9",              2,      si_ContNo);
                    RTSAVEGCTO.setString("F_ORDRBY9",              3,      si_Email);
                    RTSAVEGCTO.setString("F_ORDRBY9",              4,      si_Addr);
                    RTSAVEGCTO.setString("F_ORDRBY9",              5,      si_PAN);
                    RTSAVEGCTO.setString("F_ORDRBY9",              6,      si_TAN);
                    ...
                    if(Integer.parseInt(si_CmdtCont)>1)
                    {
                        ...
                        while(st.hasMoreTokens()) {
                            ...
                            String strWgonType=st1.nextToken();
                            logger.info("Setting input for commodity ("+intCmdtCntr+"): "+strCmdt+", "+strExpdVol+"   "+strExpdRake+"   "+strTrfcType+"   "+strWgonType);
                            ...
                            RTSAVEGCTO.setString("F_RPWBNUMB3",                intCmdtCntr,      strTrfcType);
                            RTSAVEGCTO.setString("F_CHRGDESC",                intCmdtCntr,      strWgonType);
                            intCmdtCntr++;
                        }
                    ...
                    if(Integer.parseInt(si_CmdtCont)==1)
                    {
                        ...
                        RTSAVEGCTO.setString("F_RPWBNUMB3",                0,      st.nextToken());
                    }
            }
            catch(Exception e)
            {
    ...
    public String[][] fetchDraftAppl()
    {
        ...
        for(int i=0; i<=start1-1; i++)
        {
                try
                {
                        ...
                        strData[i][22]           = RQFBDGCTQRY.getStringItemDef("F_STTNFROM",i,"0").trim();
                        strData[i][23]           = RQFBDGCTQRY.getStringItemDef("F_STTNTO",i,"0").trim();
                        strData[i][24]           = RQFBDGCTQRY.getStringItemDef("F_DVSNFROM",i,"0").trim();
                        strData[i][25]           = RQFBDGCTQRY.getStringItemDef("F_DVSNTO",i,"0").trim();
                }
        catch(Exception d)
        {
    ...
    public String[][] fetchSttsWiseAppl(String si_Stts)
    {
        String strData[][] = null;   // Variable to be returned as output of function

        logger.info("Entering fetchSttsWiseAppl....");
        logger.info("Function called with inputs :");
        logger.info("si_UserID  #"+si_UserID+"#");
        logger.info("si_ClntID  #"+si_ClntID+"#");
        logger.info("si_Stts  #"+si_Stts+"#");
        ...
        try
        {
                ...
                RQFBDGCTQRY.setString("F_USERID",               0,      si_UserID);
                RQFBDGCTQRY.setString("F_CLNTID",               0,      si_ClntID);
                RQFBDGCTQRY.setString("F_HLDGZONE",             0,      si_Stts);
                RQFBDGCTQRY.setString("F_FLAG",                 0,      "STTSWISE_APPL_LIST");
        }
        catch(Exception e)
        {
                logger.fatal("Unable to write to buffer : " + e.toString());
        ...
        for(int i=0; i<=start1-1; i++)
        {
                try
                {
                        ...
                        strData[i][22]           = RQFBDGCTQRY.getStringItemDef("F_STTNFROM",i,"0").trim();
                        strData[i][23]           = RQFBDGCTQRY.getStringItemDef("F_STTNTO",i,"0").trim();
                        strData[i][24]           = RQFBDGCTQRY.getStringItemDef("F_ZONEFROM",i,"0").trim();
                        strData[i][25]           = RQFBDGCTQRY.getStringItemDef("F_ZONETO",i,"0").trim();
                        strData[i][26]           = RQFBDGCTQRY.getStringItemDef("F_DVSNFROM",i,"0").trim();
                }
        catch(Exception d)
        {
        logger.fatal("Problem in Calling Service RQFBDGCTQRY and filling data into array" + d.toString());
    ...
    public String[] fetchAppSmry()
    {
        String strData[] = null;   // Variable to be returned as output of function

        logger.info("Entering fetchAppSmry....");
        logger.info("Function called with inputs :");
        logger.info("si_UserID  #"+si_UserID+"#");
        logger.info("si_ClntID  #"+si_ClntID+"#");
        ...
        try
        {
                ...
                RQFBDGCTQRY.setString("F_USERID",               0,      si_UserID);
                RQFBDGCTQRY.setString("F_CLNTID",               0,      si_ClntID);
                RQFBDGCTQRY.setString("F_FLAG",                 0,      "APPL_SMRY");
        }
        catch(Exception e)
        {
                logger.fatal("Unable to write to buffer : " + e.toString());
        ...
        try
        {
            strData[0]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",0,"0");
            strData[1]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",1,"0");
            strData[2]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",2,"0");
            strData[3]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",3,"0");
            strData[4]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",4,"0");
        }
        catch(Exception d)
        {
                logger.fatal("Problem in Calling Service SRVCNAME and filling Row Count into array" + d.toString());
    ...
    public String[] fetchFileList(String si_FileRfrnId)
    {
        String strData[] = null;   // Variable to be returned as output of function

        logger.info("Entering fetchFileList....");
        logger.info("Function called with inputs :");
        logger.info("si_UserID  #"+si_UserID+"#");
        logger.info("si_ClntID  #"+si_ClntID+"#");
        logger.info("si_FileRfrnId  #"+si_FileRfrnId+"#");
        ...
        try
        {
                ...
                RQFBDGCTQRY.setString("F_USERID",               0,      si_UserID);
                RQFBDGCTQRY.setString("F_CLNTID",               0,      si_ClntID);
                RQFBDGCTQRY.setString("F_FLAG",                 0,      "FILE_LIST");
                RQFBDGCTQRY.setString("F_HLDGZONE",                 0,   si_FileRfrnId);
        }
        catch(Exception e)
        {
                logger.fatal("Unable to write to buffer : " + e.toString());
        ...
        try
        {
            ...
            strData[3]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",3,"0");
            strData[4]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",4,"0");
            strData[5]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",5,"0");
            strData[6]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",6,"0");
            strData[7]          = RQFBDGCTQRY.getStringItemDef("F_ORDRBY1",7,"0");
        }
        catch(Exception d)
        {
                logger.fatal("Problem in Calling Service SRVCNAME and filling Row Count into array" + d.toString());
    ...
    public void delDraftApp(String si_RfrnId)
    {
        String strData[] = null;   // Variable to be returned as output of function

        logger.info("Entering delDraftApp....");
        logger.info("Function called with inputs :");
        logger.info("si_UserID  #"+si_UserID+"#");
        logger.info("si_ClntID  #"+si_ClntID+"#");
        logger.info("si_RfrnId  #"+si_RfrnId+"#");
        ...
        try
        {
                ...
                RTSAVEGCTO.setString("F_CLNTID",               0,       si_ClntID);
                RTSAVEGCTO.setString("F_COMMITFLAG",           0,       "Y");
                RTSAVEGCTO.setString("F_FLAG",                 0,       "DEL_GCTODRFT");
                RTSAVEGCTO.setString("F_ORDRBY8",              0,       si_RfrnId);
        }
        catch(Exception e)
        {
