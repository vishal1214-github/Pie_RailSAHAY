...
public class FrgtPymtSrvc
{
    ...
    public String[][] getCustWgmt(String si_TrxnId,String si_DateFrom,String si_DateTo,String si_Sttn)
    {
            String strData[][] = null;   // Variable to be returned as output of function
            ...
            try
            {
                    ...
                    RQCUSTWISEWGMT.setString("F_DATEFROM",     0,      si_DateFrom);
                    RQCUSTWISEWGMT.setString("F_DATETO",     0,        si_DateTo);
                    RQCUSTWISEWGMT.setString("F_CUSTCODE",     0,      si_CustCode);
            ...
            for(int i=0; i<=start1-1; i++)
            {
                ...
                {                        
                        ...
                        strData[i][7]           = RQCUSTWISEWGMT.getStringItemDef("F_ATCHSTTN",i,"0").trim();
                        strData[i][8]           = RQCUSTWISEWGMT.getStringItemDef("F_RAKENAME",i,"0").trim();
                        strData[i][9]           = RQCUSTWISEWGMT.getStringItemDef("F_CNSR",i,"0").trim();
                        strData[i][10]          = RQCUSTWISEWGMT.getStringItemDef("F_LOADNAME",i,"0").trim();
                        strData[i][11]          = RQCUSTWISEWGMT.getStringItemDef("F_FNOTNUMB",i,"0").trim();
                   }
                    catch(Exception d)
                    {
    ...
    public String[][] getCustWgmtDtls(String si_RakeID, String si_WgmtID, String si_Sttn, String si_DateFrom, String si_DateTo)
    {
            String strData[][] = null;   // Variable to be returned as output of function

            logger.info("Entering getCustWgmtDtls....");
            logger.info("Function called with inputs :");
