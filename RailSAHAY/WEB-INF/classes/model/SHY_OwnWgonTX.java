...
public class SHY_OwnWgonTX extends ArrayList
{ 
    static Logger logger = FoisLogger.getLogger(SHY_OwnWgonTX.class.getName());
    String erorCode			= null;
    
    public  String SHY_OwnWgonTX( String si_UserID, String si_ClntID,String strRefID,String strName,
                                       String strCmpyName, String strPhone,String strEmail,String strCmdt,String strWgonType, String strMesg )
 throws GG_Exception
    {
    		  String strReply			= "FAIL";	
                  String strMessg= "";
        String strReplyMesg= "";
        logger.info("Entering SHY_OwnWgonTX");
		...
		try
		{
            ...
            RTSAHAYPRTL.setString("F_ORDRBY8",     0,   strWgonType);
            RTSAHAYPRTL.setString("F_ORDRBY10",     0,   strMesg);              
            RTSAHAYPRTL.setString("F_COMMITFLAG",     0,   "Y");
            RTSAHAYPRTL.setString("F_FLAG", 0,   "SAVE_SAHYWGON");
		...
		if(erorCode != null && (!erorCode.equals("")))
		{
			...
			logger.info("Sucessfull Execution of SHY_OwnWgonTX ||RTSAHAYPRTL");
